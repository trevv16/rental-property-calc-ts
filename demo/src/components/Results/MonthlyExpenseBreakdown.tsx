...
export default function MonthlyExpenseBreakdown(props: any) {
  const fixedExpenseGroup = [
    ...
    {
      name: "Taxes",
      amount: props.propertyTaxes,
    },
    {
      name: "Insurance",
      amount: props.propertyInsurance,
    },
    {
      name: "HOA",
  ...
  const variableExpenseGroup = [
    {
      name: "Water & Sewer",
      amount: props.utility.waterSewerExpense,
    },
    {
      name: "Electricity",
      amount: props.utility.electricityExpense,
    },
    {
      name: "Gas",
      amount: props.utility.gasExpense,
    },
    {
      name: "Garbage",
      amount: props.utility.garbageExpense,
    },
    {
      name: "Other",
      amount: props.utility.otherExpense,
    },
  ];
